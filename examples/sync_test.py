...
try:
    ...
    print("Or install all analysis dependencies: pip install pyvideomeg[analysis]", file=sys.stderr)
    sys.exit(1)
...
def main():
    ...
    try:
        ...
        if len(picks_timing) == 0:
            ...
            print(f'Available STI channels: {[ch for ch in raw.info["ch_names"] if ch.startswith("STI")]}')
            return 1
